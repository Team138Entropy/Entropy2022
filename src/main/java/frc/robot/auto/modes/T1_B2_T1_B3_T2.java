...
public class T1_B2_T1_B3_T2 extends AutoModeBase {
    ...
    public T1_B2_T1_B3_T2(){
      ...
      driveActionList.add(new DriveTrajectoryAction(TrajectoryLibrary.getInstance().get_New_T1_B3()));
